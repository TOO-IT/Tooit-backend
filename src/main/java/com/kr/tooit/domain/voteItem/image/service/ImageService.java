package com.kr.tooit.domain.voteItem.image.service;
...
public class ImageService {
	...
	/**
	 * 업로드된 이미지 파일을 user객체와 연결 후 DB에 저장
	 *
	 * @param multipartFiles
	 * @return
	 */
	@Transactional
	public List<ImageDTO> uploadImageVote(User user, List<MultipartFile> multipartFiles) {
		List<ImageDTO> dtos = uploadImages(multipartFiles, "user");

		VoteImage voteImage = VoteImage.builder()
			.user(user)
			.build();
